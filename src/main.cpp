...
void loop() {
  ...
  u8g2.setForegroundColor(myWHITE);   // apply Adafruit GFX color
  transitScreen.loadAndDisplayRoute("62", "1_100252", "1_17250", 18);
  transitScreen.loadAndDisplayRoute("E Line", "1_102615", "1_7210", 11);
  transitScreen.loadAndDisplayRoute("44", "1_100224", "1_17410", 25);
  delay(15000);
}
